...
var fs = require("fs");
var vm = require("vm");
var path = "./multi-part-code-challenge/cards.js";
var code = fs.readFileSync(path);
vm.runInThisContext(code);

describe('sets up', function(){
  it('orders the deck', function(){
    assert.equal(sort(cards), 
      "Aspade' 'K spade' 'Q spade' 'J spade' '10 spade' '9 spade' '8 spade' '7 spade' '6 spade' '5 spade' '4 spade' '3 spade' '2 spade'
